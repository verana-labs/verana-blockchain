...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"vpr", "v1", "dd", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ListDIDs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"vpr", "v1", "dd", "list"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GetDID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 2}, []string{"vpr", "v1", "did", "get"}, "", runtime.AssumeColonVerbOpt(false)))
)
