...
var (
	...
	pattern_Query_IsAuthorizedIssuer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"perm", "v1", "authorized_issuer"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_IsAuthorizedVerifier_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"perm", "v1", "authorized_verifier"}, "", runtime.AssumeColonVerbOpt(false)))
)
