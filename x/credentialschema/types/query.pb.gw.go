...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"verana-labs", "verana-blockchain", "credentialschema", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ListCredentialSchemas_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"dtr", "v1", "cs", "list"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_GetCredentialSchema_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"dtr", "v1", "cs", "get", "id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RenderJsonSchema_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"dtr", "v1", "cs", "js", "id"}, "", runtime.AssumeColonVerbOpt(false)))
)
