...
const (
	Query_Params_FullMethodName   = "/verana.diddirectory.Query/Params"
	Query_ListDIDs_FullMethodName = "/verana.diddirectory.Query/ListDIDs"
	Query_GetDID_FullMethodName   = "/verana.diddirectory.Query/GetDID"
)
