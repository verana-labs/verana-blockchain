...
func init() {
	...
	md_CredentialSchema = File_verana_credentialschema_types_proto.Messages().ByName("CredentialSchema")
...
func (x *CredentialSchema) slowProtoReflect() protoreflect.Message {
	mi := &file_verana_credentialschema_types_proto_msgTypes[0]
...
func (x *fastReflection_CredentialSchema) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "verana.credentialschema.CredentialSchema.id":
		return x.Id != uint64(0)
	case "verana.credentialschema.CredentialSchema.tr_id":
		return x.TrId != uint64(0)
	case "verana.credentialschema.CredentialSchema.created":
		return x.Created != nil
	case "verana.credentialschema.CredentialSchema.modified":
		return x.Modified != nil
	case "verana.credentialschema.CredentialSchema.archived":
		return x.Archived != nil
	case "verana.credentialschema.CredentialSchema.deposit":
		return x.Deposit != uint64(0)
	case "verana.credentialschema.CredentialSchema.json_schema":
		return x.JsonSchema != ""
	case "verana.credentialschema.CredentialSchema.issuer_grantor_validation_validity_period":
		return x.IssuerGrantorValidationValidityPeriod != uint32(0)
	case "verana.credentialschema.CredentialSchema.verifier_grantor_validation_validity_period":
		return x.VerifierGrantorValidationValidityPeriod != uint32(0)
	case "verana.credentialschema.CredentialSchema.issuer_validation_validity_period":
		return x.IssuerValidationValidityPeriod != uint32(0)
	case "verana.credentialschema.CredentialSchema.verifier_validation_validity_period":
		return x.VerifierValidationValidityPeriod != uint32(0)
	case "verana.credentialschema.CredentialSchema.holder_validation_validity_period":
		return x.HolderValidationValidityPeriod != uint32(0)
	case "verana.credentialschema.CredentialSchema.issuer_perm_management_mode":
		return x.IssuerPermManagementMode != 0
	case "verana.credentialschema.CredentialSchema.verifier_perm_management_mode":
		return x.VerifierPermManagementMode != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: verana.credentialschema.CredentialSchema"))
		}
		panic(fmt.Errorf("message verana.credentialschema.CredentialSchema does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CredentialSchema) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message verana.credentialschema.CredentialSchema does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CredentialSchema) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "verana.credentialschema.CredentialSchema.id":
		panic(fmt.Errorf("field id of message verana.credentialschema.CredentialSchema is not mutable"))
	case "verana.credentialschema.CredentialSchema.tr_id":
		panic(fmt.Errorf("field tr_id of message verana.credentialschema.CredentialSchema is not mutable"))
	case "verana.credentialschema.CredentialSchema.deposit":
		panic(fmt.Errorf("field deposit of message verana.credentialschema.CredentialSchema is not mutable"))
	case "verana.credentialschema.CredentialSchema.json_schema":
		panic(fmt.Errorf("field json_schema of message verana.credentialschema.CredentialSchema is not mutable"))
	case "verana.credentialschema.CredentialSchema.issuer_grantor_validation_validity_period":
		panic(fmt.Errorf("field issuer_grantor_validation_validity_period of message verana.credentialschema.CredentialSchema is not mutable"))
	case "verana.credentialschema.CredentialSchema.verifier_grantor_validation_validity_period":
		panic(fmt.Errorf("field verifier_grantor_validation_validity_period of message verana.credentialschema.CredentialSchema is not mutable"))
	case "verana.credentialschema.CredentialSchema.issuer_validation_validity_period":
		panic(fmt.Errorf("field issuer_validation_validity_period of message verana.credentialschema.CredentialSchema is not mutable"))
	case "verana.credentialschema.CredentialSchema.verifier_validation_validity_period":
		panic(fmt.Errorf("field verifier_validation_validity_period of message verana.credentialschema.CredentialSchema is not mutable"))
	case "verana.credentialschema.CredentialSchema.holder_validation_validity_period":
		panic(fmt.Errorf("field holder_validation_validity_period of message verana.credentialschema.CredentialSchema is not mutable"))
	case "verana.credentialschema.CredentialSchema.issuer_perm_management_mode":
		panic(fmt.Errorf("field issuer_perm_management_mode of message verana.credentialschema.CredentialSchema is not mutable"))
	case "verana.credentialschema.CredentialSchema.verifier_perm_management_mode":
		panic(fmt.Errorf("field verifier_perm_management_mode of message verana.credentialschema.CredentialSchema is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: verana.credentialschema.CredentialSchema"))
		}
...
func (x *fastReflection_CredentialSchema) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in verana.credentialschema.CredentialSchema", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: verana/credentialschema/types.proto
...
func (CredentialSchemaPermManagementMode) Descriptor() protoreflect.EnumDescriptor {
	return file_verana_credentialschema_types_proto_enumTypes[0].Descriptor()
}

func (CredentialSchemaPermManagementMode) Type() protoreflect.EnumType {
	return &file_verana_credentialschema_types_proto_enumTypes[0]
}
...
func (CredentialSchemaPermManagementMode) EnumDescriptor() ([]byte, []int) {
	return file_verana_credentialschema_types_proto_rawDescGZIP(), []int{0}
}
...
type CredentialSchema struct {
	...
	IssuerPermManagementMode                CredentialSchemaPermManagementMode `protobuf:"varint,13,opt,name=issuer_perm_management_mode,json=issuerPermManagementMode,proto3,enum=verana.credentialschema.CredentialSchemaPermManagementMode" json:"issuer_perm_management_mode,omitempty"`
	VerifierPermManagementMode              CredentialSchemaPermManagementMode `protobuf:"varint,14,opt,name=verifier_perm_management_mode,json=verifierPermManagementMode,proto3,enum=verana.credentialschema.CredentialSchemaPermManagementMode" json:"verifier_perm_management_mode,omitempty"`
}
...
var File_verana_credentialschema_types_proto protoreflect.FileDescriptor

var file_verana_credentialschema_types_proto_rawDesc = []byte{
	0x0a, 0x23, 0x76, 0x65, 0x72, 0x61, 0x6e, 0x61, 0x2f, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x61, 0x6c, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e,
	...
	0x6f, 0x74, 0x6f, 0x22, 0xcf, 0x07, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69,
	0x61, 0x6c, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	...
	0x40, 0x0a, 0x08, 0x61, 0x72, 0x63, 0x68, 0x69, 0x76, 0x65, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28,
	...
	,
	...
	0x5a, 0x44, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x76, 0x65, 0x72,
	...
	,
}

var (
	file_verana_credentialschema_types_proto_rawDescOnce sync.Once
	file_verana_credentialschema_types_proto_rawDescData = file_verana_credentialschema_types_proto_rawDesc
)

func file_verana_credentialschema_types_proto_rawDescGZIP() []byte {
	file_verana_credentialschema_types_proto_rawDescOnce.Do(func() {
		file_verana_credentialschema_types_proto_rawDescData = protoimpl.X.CompressGZIP(file_verana_credentialschema_types_proto_rawDescData)
	})
	return file_verana_credentialschema_types_proto_rawDescData
}

var file_verana_credentialschema_types_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_verana_credentialschema_types_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_verana_credentialschema_types_proto_goTypes = []interface{}{
	(CredentialSchemaPermManagementMode)(0), // 0: verana.credentialschema.CredentialSchemaPermManagementMode
	(*CredentialSchema)(nil),                // 1: verana.credentialschema.CredentialSchema
	(*timestamppb.Timestamp)(nil),           // 2: google.protobuf.Timestamp
}
var file_verana_credentialschema_types_proto_depIdxs = []int32{
	2, // 0: verana.credentialschema.CredentialSchema.created:type_name -> google.protobuf.Timestamp
	2, // 1: verana.credentialschema.CredentialSchema.modified:type_name -> google.protobuf.Timestamp
	2, // 2: verana.credentialschema.CredentialSchema.archived:type_name -> google.protobuf.Timestamp
	0, // 3: verana.credentialschema.CredentialSchema.issuer_perm_management_mode:type_name -> verana.credentialschema.CredentialSchemaPermManagementMode
	0, // 4: verana.credentialschema.CredentialSchema.verifier_perm_management_mode:type_name -> verana.credentialschema.CredentialSchemaPermManagementMode
...
func init() { file_verana_credentialschema_types_proto_init() }
func file_verana_credentialschema_types_proto_init() {
	if File_verana_credentialschema_types_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_verana_credentialschema_types_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_verana_credentialschema_types_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_verana_credentialschema_types_proto_goTypes,
		DependencyIndexes: file_verana_credentialschema_types_proto_depIdxs,
		EnumInfos:         file_verana_credentialschema_types_proto_enumTypes,
		MessageInfos:      file_verana_credentialschema_types_proto_msgTypes,
	}.Build()
	File_verana_credentialschema_types_proto = out.File
	file_verana_credentialschema_types_proto_rawDesc = nil
	file_verana_credentialschema_types_proto_goTypes = nil
	file_verana_credentialschema_types_proto_depIdxs = nil
}
