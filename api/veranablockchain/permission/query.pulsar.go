...
var file_veranablockchain_permission_query_proto_rawDesc = []byte{
	...
	0x0b, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x32, 0xae, 0x02, 0x0a,
	...
	0x2f, 0x70, 0x65, 0x72, 0x6d, 0x2f, 0x76, 0x31, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x42, 0x84, 0x02,
	...
	0x72, 0x61, 0x6e, 0x61, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2f, 0x70,
	...
	0x69, 0x6e, 0x2e, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0xca, 0x02, 0x1b,
	0x56, 0x65, 0x72, 0x61, 0x6e, 0x61, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x63, 0x68, 0x61, 0x69, 0x6e,
	0x5c, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0xe2, 0x02, 0x27, 0x56, 0x65,
	...
	0x6f, 0x63, 0x6b, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x3a, 0x3a, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73,
...
var file_veranablockchain_permission_query_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_veranablockchain_permission_query_proto_goTypes = []interface{}{
	...
	(*Params)(nil),                       // 4: veranablockchain.permission.Params
	(*timestamppb.Timestamp)(nil),        // 5: google.protobuf.Timestamp
	(*Permission)(nil),                   // 6: veranablockchain.permission.Permission
}
var file_veranablockchain_permission_query_proto_depIdxs = []int32{
	4, // 0: veranablockchain.permission.QueryParamsResponse.params:type_name -> veranablockchain.permission.Params
	5, // 1: veranablockchain.permission.QueryListPermissionsRequest.modified_after:type_name -> google.protobuf.Timestamp
	6, // 2: veranablockchain.permission.QueryListPermissionsResponse.permissions:type_name -> veranablockchain.permission.Permission
	0, // 3: veranablockchain.permission.Query.Params:input_type -> veranablockchain.permission.QueryParamsRequest
	2, // 4: veranablockchain.permission.Query.ListPermissions:input_type -> veranablockchain.permission.QueryListPermissionsRequest
	1, // 5: veranablockchain.permission.Query.Params:output_type -> veranablockchain.permission.QueryParamsResponse
	3, // 6: veranablockchain.permission.Query.ListPermissions:output_type -> veranablockchain.permission.QueryListPermissionsResponse
