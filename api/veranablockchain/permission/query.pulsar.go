...
var file_veranablockchain_permission_query_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_veranablockchain_permission_query_proto_goTypes = []interface{}{
	...
	(*Params)(nil),              // 2: veranablockchain.permission.Params
}
var file_veranablockchain_permission_query_proto_depIdxs = []int32{
	2, // 0: veranablockchain.permission.QueryParamsResponse.params:type_name -> veranablockchain.permission.Params
	0, // 1: veranablockchain.permission.Query.Params:input_type -> veranablockchain.permission.QueryParamsRequest
	1, // 2: veranablockchain.permission.Query.Params:output_type -> veranablockchain.permission.QueryParamsResponse
