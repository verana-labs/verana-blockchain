...
func init() {
	file_veranablockchain_trustdeposit_types_proto_init()
	md_SlashTrustDepositProposal = File_veranablockchain_trustdeposit_types_proto.Messages().ByName("SlashTrustDepositProposal")
...
func (x *SlashTrustDepositProposal) slowProtoReflect() protoreflect.Message {
	mi := &file_veranablockchain_trustdeposit_types_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_SlashTrustDepositProposal) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "veranablockchain.trustdeposit.SlashTrustDepositProposal.title":
		return x.Title != ""
	case "veranablockchain.trustdeposit.SlashTrustDepositProposal.description":
		return x.Description != ""
	case "veranablockchain.trustdeposit.SlashTrustDepositProposal.account":
		return x.Account != ""
	case "veranablockchain.trustdeposit.SlashTrustDepositProposal.amount":
		return x.Amount != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: veranablockchain.trustdeposit.SlashTrustDepositProposal"))
		}
		panic(fmt.Errorf("message veranablockchain.trustdeposit.SlashTrustDepositProposal does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SlashTrustDepositProposal) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message veranablockchain.trustdeposit.SlashTrustDepositProposal does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SlashTrustDepositProposal) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "veranablockchain.trustdeposit.SlashTrustDepositProposal.title":
		panic(fmt.Errorf("field title of message veranablockchain.trustdeposit.SlashTrustDepositProposal is not mutable"))
	case "veranablockchain.trustdeposit.SlashTrustDepositProposal.description":
		panic(fmt.Errorf("field description of message veranablockchain.trustdeposit.SlashTrustDepositProposal is not mutable"))
	case "veranablockchain.trustdeposit.SlashTrustDepositProposal.account":
		panic(fmt.Errorf("field account of message veranablockchain.trustdeposit.SlashTrustDepositProposal is not mutable"))
	case "veranablockchain.trustdeposit.SlashTrustDepositProposal.amount":
		panic(fmt.Errorf("field amount of message veranablockchain.trustdeposit.SlashTrustDepositProposal is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: veranablockchain.trustdeposit.SlashTrustDepositProposal"))
		}
...
func (x *fastReflection_SlashTrustDepositProposal) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in veranablockchain.trustdeposit.SlashTrustDepositProposal", d.FullName()))
	}
	panic("unreachable")
}
...
func (*SlashTrustDepositProposal) Descriptor() ([]byte, []int) {
	return file_veranablockchain_trustdeposit_types_proto_rawDescGZIP(), []int{1}
}
...
var file_veranablockchain_trustdeposit_types_proto_rawDesc = []byte{
	...
	0x6f, 0x73, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67,
	0x52, 0x0c, 0x6c, 0x61, 0x73, 0x74, 0x52, 0x65, 0x70, 0x61, 0x69, 0x64, 0x42, 0x79, 0x22, 0xf3,
	0x01, 0x0a, 0x19, 0x53, 0x6c, 0x61, 0x73, 0x68, 0x54, 0x72, 0x75, 0x73, 0x74, 0x44, 0x65, 0x70,
	...
	0x22, 0x52, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2c,
	0x0a, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42,
	0x12, 0xf2, 0xde, 0x1f, 0x0e, 0x79, 0x61, 0x6d, 0x6c, 0x3a, 0x22, 0x61, 0x63, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x22, 0x52, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x46, 0x0a, 0x06,
	0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x2e, 0xc8, 0xde,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x42, 0x90, 0x02, 0x0a, 0x21, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x65, 0x72,
	0x61, 0x6e, 0x61, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x74, 0x72,
...
var file_veranablockchain_trustdeposit_types_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_veranablockchain_trustdeposit_types_proto_goTypes = []interface{}{
	...
	(*SlashTrustDepositProposal)(nil), // 1: veranablockchain.trustdeposit.SlashTrustDepositProposal
	(*timestamppb.Timestamp)(nil),     // 2: google.protobuf.Timestamp
}
var file_veranablockchain_trustdeposit_types_proto_depIdxs = []int32{
	2, // 0: veranablockchain.trustdeposit.TrustDeposit.last_slashed:type_name -> google.protobuf.Timestamp
	2, // 1: veranablockchain.trustdeposit.TrustDeposit.last_repaid:type_name -> google.protobuf.Timestamp
...
func file_veranablockchain_trustdeposit_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_veranablockchain_trustdeposit_types_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
