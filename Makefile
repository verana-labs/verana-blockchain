...
test:
	@echo "Running tests..."
	@go test ./x/trustregistry/keeper/... ./x/diddirectory/keeper/... ./x/credentialschema/keeper/... ./x/cspermission/keeper/...

test-verbose:
	@echo "Running tests with verbose output..."
	@go test -v ./x/trustregistry/keeper/... ./x/diddirectory/keeper/... ./x/credentialschema/keeper/... ./x/cspermission/keeper/...

test-coverage:
	@echo "Running tests with coverage..."
	@go test -coverprofile=coverage.out ./x/trustregistry/keeper/... ./x/diddirectory/keeper/... ./x/credentialschema/keeper/... ./x/cspermission/keeper/...
